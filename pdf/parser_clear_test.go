...
func TestParseClear(t *testing.T) {
	...
	d, err := os.ReadFile("testdata/clear_nota_compra.give")
	if err != nil {
		panic(err)
	}
		...
		Negociacoes: []Negociacao{
			{
				...
				ValorTotal:    decimal.RequireFromString("383"),
				CD:            "D",
			},
			{
				CV:            "C",
				...
				ValorTotal:    decimal.RequireFromString("3015"),
				CD:            "D",
			},
			{
				CV:            "C",
				...
				ValorTotal:    decimal.RequireFromString("942"),
				CD:            "D",
			},
		},
